...
mod tests {
    ...
    fn test_multiplier2_serialization_deserialization() -> Result<()> {
        test_circuit_serialization_deserialization("./test-vectors/multiplier2_final.zkey")
    }

    #[test]
    fn test_keccak256_serialization_deserialization() -> Result<()> {
        test_circuit_serialization_deserialization("./test-vectors/keccak256_256_test_final.zkey")
    }

    #[test]
    #[ignore = "rsa_final.zkey is too large to run on CI"]
    fn test_rsa_serialization_deserialization() -> Result<()> {
        test_circuit_serialization_deserialization("./test-vectors/rsa_final.zkey")
    }
}
